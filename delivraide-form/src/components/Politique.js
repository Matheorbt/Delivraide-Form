    ...
    return (
        <div>
            <div class="about-section-validation">
                ...
                <p class="p-confidentialité">Conformément aux dispositions de l'article 5 du Règlement européen 2016/679, la collecte et le traitement des données des utilisateurs du site respectent les principes suivants :</p>
                ...
                <p class="p-confidentialité">Afin d'être licites, et ce conformément aux exigences de l'article 6 du règlement européen 2016/679, la collecte et le traitement des données à caractère personnel ne pourront intervenir que s'ils respectent au moins l'une des conditions ci-après énumérées :</p>
                <div class="div-li-politique">
                ...
                <p class="p-confidentialité">Le site <a href="https://delivraide.org">https://delivraide.org </a> est hébergé par : https://oxide.host , dont le siège est situé à l'adresse ci-après : 4600 East Washington Street Suite 305 Phoenix, AZ 85034 USA.</p>
                ...
                <p class="p-confidentialité">Conformément aux dispositions du règlement 2016/679, l'utilisateur a le droit de ne pas faire l'objet d'une décision fondée exclusivement sur un procédé automatisé si la décision produit des effets juridiques le concernant, ou l'affecte de manière significative de façon similaire.</p>
                <p class="p-confidentialité">d. Droit de déterminer le sort des données après la mort</p>
                <p class="p-confidentialité">Il est rappelé au bénéficiaire qu'il peut organiser quel doit être le devenir de ses données collectées et traitées s'il décède, conformément à la loi n°2016-1321 du 7 octobre 2016.</p>
